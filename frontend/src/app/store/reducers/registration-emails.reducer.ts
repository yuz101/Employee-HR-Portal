...
export const registrationEmailReducer = createReducer(
  ...
  on(RegistrationEmailActions.getAllRegistrationEmails, (state, { registrationsEmails }) => registrationsEmails),
  on(RegistrationEmailActions.addRegistrationEmail, (state, { registrationEmail }) => ({...state, registrationEmail})),
  on(RegistrationEmailActions.resendRegistrationEmail, (state, { registrationEmail }) => state.map((each) => each._id === registrationEmail._id ? registrationEmail : each)),
